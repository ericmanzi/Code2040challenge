...
//Excuse all the print statements, a lot of debugging was done here
...
public class SendPost {
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~GET NEEDLE IN HAYSTACK~~~~~~~~~~~~~~~~~~~~
	 ...
	 //~~~~~~~~~~~~~~~~~~~~~~~~~~~FOUND NEEDLE~~~~~~~~~~~~~
		...
		HashMap<String, JSONArray> hash2 = jsonToMap(want, "needle");
...
//		json5.put("needle", Integer.toString(index));
	...
	HttpPost post5 = new HttpPost("http://challenge.code2040.org/api/validateneedle");
		...
		String want1 = input6.substring(10, input6.length()-1);
		HashMap<String, JSONArray> hash21 = jsonToMap(want1, "array");
		String[] result = SendPost.findPrefixMatch(hash21.get("array"), prefix);
...
//~~~~~~~~~~~~~~~~~~~~~~~~FINAL CHALLENGE~~~~~~~~~~~~~~~~
		...
		String want11 = input8.substring(10, input8.length()-1);
		int interval = getInterval(want11).get("interval");
		String date = getKeyfromJson(want11, "datestamp");
